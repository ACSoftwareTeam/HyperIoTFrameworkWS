...
public class HBaseConnectorRestApi extends  HyperIoTBaseRestApi  {
	...
	public Response checkConnection() {
		getLog().log(Level.FINE, "In REST Service GET /hyperiot/hbase/checkConnection");
		try {
	...
	public Response checkModuleWorking() {
		getLog().log(Level.FINE, "In Rest Service GET /hyperiot/hbaseconnector/module/status");
	...
	public Response createTable(
		...
		getLog().log(Level.FINE, "In Rest Service POST /hyperiot/hbaseconnector/tables");
		getLog().log(Level.FINE, "\t tableName: {0}", tableName);
		getLog().log(Level.FINE, "\t columnFamilies: {0}", columnFamilies);
		try {
	...
	public Response deleteData(
		...
		getLog().log(Level.FINE, "In Rest Service DELETE hyperiot/hbaseconnector/tables/rows");
		getLog().log(Level.FINE, "\t tableName: {0}", tableName);
		getLog().log(Level.FINE, "\t rowKey: {0}", rowKey);
		try {
    ...
    public Response dropTable(
        ...
        getLog().log(Level.FINE, "In Rest Service DELETE /hyperiot/hbaseconnector/tables/{0}", tableName);
        try {
    ...
    public Response enableTable(
        ...
        getLog().log(Level.FINE, "In Rest Service PUT hyperiot/hbaseconnector/tables/{0}/{1}", new Object[] {tableName, enabled});
        try {
        	if (enabled)
	...
	public Response insertData(
		...
		getLog().log(Level.FINE, "In Rest Service PUT hyperiot/hbaseconnector/tables");
		getLog().log(Level.FINE, "\t tableName: {0}", tableName);
		getLog().log(Level.FINE, "\t rowKey: {0}", rowKey);
		getLog().log(Level.FINE, "\t columnFamily: {0}", columnFamily);
		getLog().log(Level.FINE, "\t column: {0}", column);
		getLog().log(Level.FINE, "\t cellValue: {0}", cellValue);
		try {
