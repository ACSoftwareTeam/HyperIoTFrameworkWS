...
public class HyperIoTAuthenticationFilter extends HyperIoTJwtFilter
    ...
    private static final Logger log = Logger.getLogger(HyperIoTAuthenticationFilter.class.getName());
    ...
    public HyperIoTAuthenticationFilter() {
        super();
        log.log(Level.FINE, "HyperIoTAuthenticationFilter : Loading properties from config file");
    ...
    protected void validateToken(JwtToken jwt) {
        log.log(Level.FINE, "HyperIoTAuthenticationFilter : validateToken");
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        log.log(Level.FINER, "In HyperIoTAuthenticationFilter on class: {0}.{1}", new Object[]{info.getResourceClass(), info.getResourceMethod()});
        try {
            super.filter(requestContext);
        } catch (Throwable e) {
            log.log(Level.FINER, "Error in Authentication filter:", e);
