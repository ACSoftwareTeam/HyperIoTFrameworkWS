...
public class HyperIoTSecurityUtil {
            ...
            if (configurationAdminReference != null) {
                ...
                try {
                    ...
                    if (configuration != null && configuration.getProperties() != null) {
                        ...
                        log.log(Level.FINER, "Loaded properties from JWT Filter: {0}", props);
                        return props;
                    }
                } catch (IOException e) {
                    log.log(Level.SEVERE,
                        "Impossible to find {0}", new Object[]{HyperIoTConstants.HYPERIOT_JWT_CONFIG_FILE_NAME, e});
                    return null;
                }
            }
            log.log(Level.SEVERE,
                "Impossible to find {0}", new Object[]{HyperIoTConstants.HYPERIOT_JWT_CONFIG_FILE_NAME});
            return null;
        }
        return props;
    }
    ...
    public static HyperIoTPermissionManager getPermissionManager(HyperIoTContext ctx) {
        ...
        String permissionFilter = OSGiFilterBuilder
            ...
            .getFilter();
        log.log(Level.FINE,
            "Searching for OSGi registered Permission with filter: {0}", permissionFilter);
        try {
            ...
            if (serviceReferences.size() > 1) {
                log.log(Level.FINE, "No OSGi action found for filter: {0}", permissionFilter);
            ...
            log.log(Level.FINE, "OSGi permission manager found {0}", permissionManager);
    ...
    public static Cipher getCipherRSA(String padding) throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException {
        ...
        if (padding == null) {
            ...
            return Cipher.getInstance("RSA/NONE/" + padding);
        }
    }
     ...
     * @throws NoSuchAlgorithmException
     */
    public static Cipher getCipherAES() throws NoSuchPaddingException, NoSuchAlgorithmException {
     ...
     */
    public static synchronized byte[] decodeMessageWithServerPrivateKey(byte[] cipherText, Cipher asymmetricCipher) {
     ...
     * @return Decoded String message using the current private key loaded form the keystore
     */
    public static synchronized byte[] decodeMessageWithPrivateKey(PrivateKey key, byte[] cipherText, Cipher asymmetricCipher) {
        try {
            // initialize your cipher
            asymmetricCipher.init(Cipher.DECRYPT_MODE, key);
            // asuming, cipherText is a byte array containing your encrypted message
    ...
    /**
     * @return Random 16 byte init vector
     */
