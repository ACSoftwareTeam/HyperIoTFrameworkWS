...
public class HyperIoTQueryFilterAndCondition implements HyperIoTQueryFilter {
    private HyperIoTQueryFilter left;
    private HyperIoTQueryFilter right;
    private boolean not;

    public HyperIoTQueryFilterAndCondition(HyperIoTQueryFilter left, HyperIoTQueryFilter right) {
        this.left = left;
        this.right = right;
    }
