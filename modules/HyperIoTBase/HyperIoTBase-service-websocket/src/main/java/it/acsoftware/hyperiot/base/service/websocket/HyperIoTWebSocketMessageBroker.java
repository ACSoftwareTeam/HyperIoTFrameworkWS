...
public class HyperIoTWebSocketMessageBroker {
    ...
    private Logger log = Logger.getLogger("it.ascsoftware.hyperiot");
    private Session session;
    private static ObjectMapper mapper = new ObjectMapper();

    private HyperIoTWebSocketEncryptionPolicy encryptionPolicy;
    private HyperIoTWebSocketCompressionPolicy compressionPolicy;
     ...
     */
    public void setEncryptionPolicy(HyperIoTWebSocketEncryptionPolicy encryptionPolicy) {
     ...
     */
    public void setCompressionPolicy(HyperIoTWebSocketCompressionPolicy compressionPolicy) {
     ...
     */
    private byte[] processMessageBeforeSend(byte[] message, boolean encodeBase64) throws NoSuchPaddingException, InvalidAlgorithmParameterException, UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        if (encryptionPolicy != null) {
     ...
     * @throws InvalidKeyException
     */
    private byte[] processMessageBeforeRead(byte[] message, boolean decodeBase64BeforeDecrypt) throws NoSuchPaddingException, InvalidAlgorithmParameterException, UnsupportedEncodingException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        if (compressionPolicy != null) {
