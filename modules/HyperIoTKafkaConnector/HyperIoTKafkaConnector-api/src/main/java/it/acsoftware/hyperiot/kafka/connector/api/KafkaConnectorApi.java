...
public interface KafkaConnectorApi {
    ...
    Flux<ReceiverRecord<byte[], byte[]>> consumeReactive(String kafkaGroupId, List<String> topics, Class keyDeserializerClass, Class valueDeserializerClass) throws ClassNotFoundException;
     ...
     * @return
     */
    Flux<ReceiverRecord<byte[], byte[]>> consumeReactive(String kafkaGroupId, String topic, int partition, Class keyDeserializerClass, Class valueDeserializerClass) throws ClassNotFoundException;
     ...
     * @throws ClassNotFoundException
     */
    void consumeReactive(String kafkaGroupId, Pattern topicPattern, Class keyDeserializerClass, Class valueDeserializerClass) throws ClassNotFoundException;
